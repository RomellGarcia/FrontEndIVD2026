    ...
    const fetchPerfil = async () => {
      try {
        ...
        setDatosEmpresa({
          ...
          mostrarWhatsapp: response.data.perfil.mostrar_whatsapp || true, // Asumir true si no existe
        });
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <Link to="/atleta/politicaspca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <SafetyOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Política de Privacidad
            </Link>
            <Link to="/atleta/terminospca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <FileTextOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Términos y Condiciones
            </Link>
            <Link to="/atleta/visionpca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <ThunderboltOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Misión
            </Link>
            <Link to="/atleta/misionpca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
...
export default PieDePaginaAtleta;