      ...
      >
        ...
        >
          ...
          <div>
            ...
            <Link to="/entrenador/politicaspca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <SafetyOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Política de Privacidad
            </Link>
            <Link to="/entrenador/terminospca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <FileTextOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Términos y Condiciones
            </Link>
            <Link to="/entrenador/visionpca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
              <ThunderboltOutlined style={{ fontSize: '18px', marginRight: '5px', color: '#F5E8C7' }} /> Misión
            </Link>
            <Link to="/entrenador/misionpca" style={{ color: '#F5E8C7', fontSize: '16px', display: 'block', marginBottom: '10px', textDecoration: 'none' }}>
...
export default PieDePaginaEntrenador;
